    ...
    <div class="container mt-3">
        ...
        <form action="" method="post">
            <div class="row mt-3">
                ...
                <div class="col-sm-2">
                    <button class="btn btn-primary" formaction="tela_cadastro.php">&#128269;</button>
                </div>
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="txtNascimento"
                        placeholder="Data de Nascimento do Usuário" value = " <?= $nascusuario?>">
